...
// var image = $('#img-'+product_id).offset();
// if (image) {
// var cart = $('#cart').offset();
// $('<img src="' + $('#img-'+product_id).attr('src') + '" id="temp" style="position: absolute; z-index:9999; top: ' + image.top + 'px; left: ' + image.left + 'px;" />').appendTo('body');
// params = {
// top : cart.top + 'px',
// left : cart.left + 'px',
// opacity : 0.2,
// width :$('#img-'+product_id).width(),
// height : $('#img-'+product_id).height()
// };

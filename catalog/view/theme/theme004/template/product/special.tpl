  ...
  <div class="product-list">
    ...
    <div>
      ...
      <?php } ?>
       ...
       <div class="cart"><table class="count_tabla">
                      <tr>
                        <td><a class="plusminuscat" style="font-size:14px;" onclick="minuscon(<?php echo $product['product_id']; ?>);">-</a></td>
                        <td><input type="text" name="quantity"  id="quant-<?php echo $product['product_id']; ?>" size="3" value="1" class="qyinput" /></td>
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-list > div').each(function(index, element) {
			...
			if (image != null) {
				html += '<div class="boxgrid caption"><div class="image">' + image + '</div><div class="cover boxcaption"><a href="#" data-reveal-id="' + cid + '" data-animation="fade" class="button"><span>Быстрый просмотр<span></a></div><div class="cid" style="display:none;">' + cid + '</div></div>';
			}

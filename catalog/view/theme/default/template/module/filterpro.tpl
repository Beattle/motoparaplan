...
<div class="price_slider" <?php if(!$price_slider) { echo 'style="display:none"';}?>>
	...
	<table style="width:100%;">
		<tr>
			<td style="width:40px;"><input class="price_limit" type="text" name="min_price" value="-1" id="min_price"/><?php if($symbol_right){ echo "<td><b>".$symbol_right."</b></td>";}?></td>
			<td></td>
			<td style="width:40px;float:right;"><input class="price_limit" type="text" name="max_price" value="-1" id="max_price"/><?php if($symbol_right){ echo "<td style=\"width:10px;\"><b>".$symbol_right."</b></td>";}?></td>
		</tr>
	</table>
...
<script id="productTemplate" type="text/x-jquery-tmpl">
	<div>
		...
		<div class="boxgrid caption">
			<div class="image"><a href="${href}"><img src="${thumb}" id="img-${product_id}" title="${name}" alt="${name}" /></a></div>
			<div class="cover boxcaption">
				<a href="#" data-reveal-id="${product_id}" data-animation="fade" class="button-detail">Быстрый просмотр</a>
				<div class="cid" style="display:none;">${product_id}</div>
			</div>
		</div>
		{{/if}}
		<div class="name">
		...
		{{/if}}
		<div class="cart" style="width:100%;display:block;float:left;">
			<table class="count_tabla">
                      <tr>
                        <td><a class="plusminuscat" style="font-size:14px;" onclick="minuscon(${product_id});">-</a></td>
                        <td><input type="text" name="quantity"  id="quant-${product_id}" size="3" value="1" class="qyinput" /></td>
                        <td><a class="plusminuscat" onclick="pluscon(${product_id});">+</a></td>
                        <input type="hidden" name="product_id" size="2" value="${product_id}" />
                      </tr>
            </table>
			
			<div class="details"><a class="button-details" href="${href}">Подробнее</a></div>
			
            <a onclick="addToCart('${product_id}');" class="button-featured"><span><?php echo $button_cart; ?></span></a>
		</div>
...
<script id="productTemplatehidden" type="text/x-jquery-tmpl">
	<div id="${product_id}" class="reveal-modal">
	     <div class="modal">
		    <div class="contents">

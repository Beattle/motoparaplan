      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          <div id="language-<?php echo $module_row; ?>" class="htabs">
			...
			<td class="left"><select name="proscroller_module[<?php echo $module_row; ?>][manufacturer_id]" id ="select<?php echo $module_row; ?>">
...
function addModule() {	
	...
	html += '      <td><select name="proscroller_module[' + module_row + '][manufacturer_id]" id="select' + module_row + '">';
